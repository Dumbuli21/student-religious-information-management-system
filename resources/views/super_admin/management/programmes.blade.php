                ...
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview active">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('super_admin.departments.index') }}" class="nav-link text-white-75">
                                    <i class="nav-icon bi bi-building"></i>
                                    <p class="nav-text">Department</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('super_admin.programmes.index') }}" class="nav-link text-white-75 active">
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('super_admin.programmes.store') }}">
                @csrf
...
const routes = {
    show: '{{ route('super_admin.programmes.show', '__ID__') }}',
    update: '{{ route('super_admin.programmes.update', '__ID__') }}',
    destroy: '{{ route('super_admin.programmes.destroy', '__ID__') }}',
};
